...
class AddStudent : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        calendar.set(currentYear, calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH))
        calendar1.set(currentYear-100, calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH))
